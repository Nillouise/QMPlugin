...
namespace test
{
	...
	long findMonster(Cdmsoft dm, int rangeX = 0, int rangeY = 0, int rangeWidth = 800, int rangeHeight = 600,WCHAR *MonColor = L"f59ebc-010101",double similar=1.0,int PointCount=500,int monWidth = 30,int monHeight =30);
	class CMonster
	{
	public:
		int x;
	...
	extern std::priority_queue<CKeyOp> pqKeyOp;
}