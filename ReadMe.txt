========================================================================
    MICROSOFT 基础类库 : QMPlugin 项目概述
========================================================================


应用程序向导已为您创建了此 QMPlugin DLL。  此 DLL 不仅演示 
Microsoft 基础类的基本使用方法，还可作为您编写 DLL 的起点。

本文件概要介绍组成 QMPlugin DLL 的每个文件的内容。
...
QMPlugin.h
    这是 DLL 的主头文件。  它声明了 CQMPluginApp 类。

QMPlugin.cpp
    这是主 DLL 源文件。  它包含 CQMPluginApp 类。
...
StdAfx.h，StdAfx.cpp
    这些文件用于生成名为 QMPlugin.pch 的预编译头 (PCH) 文件和名为 
    StdAfx.obj 的预编译类型文件。
